...
class ExpertFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $expertiseSubjects = ['Frontend', 'Backend', 'Design', 'DevOps', 'Gestion'];
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            // Nouveau format d'expertises
            $expert->setExpertises(array_map(fn($s) => [
                'subject' => $s,
                'A' => rand(60, 95),
                'fullMark' => 100
            ], $faker->randomElements($expertiseSubjects, rand(2, 5))));
