// assets/src/pages/public/ServicesPage.jsx
                            ...
                            <Grid item xs={12} sm={6} md={4} key={service.id}>
                                <Card sx={styles.card}>
                                    ...
                                    <CardContent sx={{ flexGrow: 1 }}>
                                        ...
                                        {Array.isArray(service.featureDetails) && service.featureDetails.length > 0 && (
                                            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5, mb: 2 }}>
                                                {service.featureDetails.slice(0, 3).map((f, index) => (
                                                    <Tooltip key={index} title={`+€${f.price} - ${f.description}`}>
                                                        <Chip label={f.name} color="primary" size="small" icon={<Star />} />
                                                    </Tooltip>
                                                ))}
                                            </Box>
                                        )}
