...
class Service
{
    ...
    #[Groups(['service:detail','service:list'])]
    private ?array $featureDetails = null; // array of objects with name, description, price, icon

    #[ORM\Column(type: Types::BOOLEAN)]
    #[Groups(['service:detail'])]
    private bool $requiresCall = false;
    ...
    public function setFeatureDetails(?array $featureDetails): static
    {
        $this->featureDetails = $featureDetails;
        return $this;
    }

    public function isRequiresCall(): bool
    {
        return $this->requiresCall;
    }

    public function setRequiresCall(bool $requiresCall): static
    {
