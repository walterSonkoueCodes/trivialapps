...
const VerificationSuccessPage = lazy(() => import('./pages/public/verificationSuccessPage'));
const VerificationErrorPage = lazy(() => import('./pages/public/VerificationErrorPage'));
const ResendVerificationPage = lazy(() => import('./pages/public/ResendVerificationPage'));
